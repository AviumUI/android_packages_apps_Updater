...
resource (or the `avium.updater.uri` system property) and expects as response
...
The `version` attribute is the string to be compared with the `ro.avium.version` property.  
