 ...
 */
package org.avium.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.avium.version";
    public static final String PROP_DEVICE = "ro.lineage.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "avium.updater.allow_downgrading";
    public static final String PROP_UPDATER_ALLOW_MAJOR_UPDATE = "avium.updater.allow_major_update";
    public static final String PROP_IS_OFFICIAL = "ro.avium.is_official";
